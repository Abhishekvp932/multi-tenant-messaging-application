...
export class GroupService implements IGroupService {
    ...
    async createGroup(name: string, createrId: string): Promise<{ msg: string, group?: any }> {
    ...
    async getAllGroups(createrId: string): Promise<any[]> {
    ...
    async getGroupsByMember(memberId: string): Promise<any[]> {
